...
class GsonTest {
    ...
    @Test
    fun string_JsonToList() {
        val jsonString = """[{"name":"hsk","value":1},{"name":"hsk","value":2}]"""
        val expected = (1..2).map { User(name = "hsk", value = it) }
        assertThat(jsonString.jsonToList<User>()).isEqualTo(expected)
    }
}